...
class BaseStructures():
    ...
    # Returns a dict where key is a unique key (generated by me) and the info
    # for the Data Element as value (in a list).
        ...
        with open(filename) as csvfile:
            ...
            for row in crdr:
                if row[0].lstrip().startswith('#'):
                    ...
                    p1 = self.getPrefix1(row[0])
                    p2 = self.getPrefix2(row[0])
